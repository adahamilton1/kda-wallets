  ...
  <dialog>
    <section>
      <header style="display: flex; align-items: center; gap: 1em;">
        ...
        <button type="button" style="background:none; border:none; cursor:pointer; display:flex; align-items: start;">
          <svg height="1.5em" width="1.5em" id="Layer_1" style="enable-background:new 0 0 512 512;" version="1.1" viewBox="0 0 512 512" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
